...
if (isset($_GET['roomno'])){
    $roomno = $_GET['roomno'];
    $delete=mysqli_query($connection,"DELETE FROM `room` WHERE `roomno`='$roomno'");
}
?>
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
       ...
       $sql = "INSERT INTO `room` (`roomno`, `capacity`) VALUES ('$roomno', '$capacity')";
...
<!--<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <section class="container">
        ...
        <div class="form">
            <form action="/esas/room.php" method="post">
            <input class="form-input" type="text" name="roomno" id="roomno" placeholder="Room No">
            <input class="form-input" type="text" name="capacity" id="capacity" placeholder="Room Capacity">
    ...
    <div class="table">
        <table border="1" cellpadding="0">
            ...
            <td>". $row['roomno'] . "</td>
            <td>". $row['capacity'] . "</td>
            <td><a href='room.php?roomno=".$row['roomno'] . "' class='btn'>Delete</a></td>
            </tr>";
            }
